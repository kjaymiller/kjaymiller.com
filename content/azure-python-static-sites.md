...
image: https://jmblogstorrage.blob.core.windows.net/media/az%20deployment%20build.png
...
![output of my static site generator building files](https://jmblogstorrage.blob.core.windows.net/media/render-engine-output.png)
...
![gif of building out the steps in VS Code](https://jmblogstorrage.blob.core.windows.net/media/NewSWAApp.gif)
...
![The build in GH Actions](https://jmblogstorrage.blob.core.windows.net/media/Build%20in%20github%20actions.png)
...
![The Successful build with url](https://jmblogstorrage.blob.core.windows.net/media/az%20deployment%20build.png)

You can also refresh the Azure Section of VS Code and it should be visible.

![The new SWA in VS Code](https://jmblogstorrage.blob.core.windows.net/media/swa-output-vs-code.png)
